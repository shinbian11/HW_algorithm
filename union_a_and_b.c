...
int main()
{
	...
	//---------(b) 합치기-------------
	union_(4, 5); //4 <- 5 형태의 집합 만들기
	union_(6, 7); //6 <- 7 형태의 집합 만들기
	union_(6, 8); //6 <- 8 형태의 집합 만들기
	union_(6, 9); //6 <- 9 형태의 집합 만들기
	union_(4, 6); //4 <- 5 형태의 집합과 6<-7,8,9 형태의 집합을 합치기

	//---------(a)와 (b) 합치기-------------
	union_(1, 4); //각각 만들어놓은 (a)와 (b)를 합치기
